...
num_to_gen = 90000
save_path = '/local/scratch/wd263/my_dsprites/raw2/'
...
def rand_ellipse(size_low=16.0/64,size_high=28.0/64, hw_ratio = 0.6, margin = 0.02):
...
def rand_square(size_low=15.0/64,size_high=21.0/64, margin = 0.02):
...
def rand_triangle(size_low=7.0/64,size_high=20.0/64, margin = 0.02):
    s = np.random.uniform(size_low,size_high)
...
def check_dist(center_list,s_list,x,y,s, d = 0.25**2):
